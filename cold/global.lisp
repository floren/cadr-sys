...
(DEFCONST INITIAL-GLOBAL-SYMBOLS '(
;;;; Useful byte-pointers and constants:
 ...
 %%CH-FONT					;char-font
 %%KBD-CHAR
 %%KBD-CONTROL					;(char-control-bit)
 %%KBD-CONTROL-META				;char-bits
 %%KBD-HYPER					;(char-hyper-bit)
 %%KBD-META					;(char-meta-bit)
 %%KBD-MOUSE
 %%KBD-MOUSE-BUTTON
 %%KBD-MOUSE-N-CLICKS
 %%KBD-SUPER					;(char-super-bit)
 %%Q-ALL-BUT-CDR-CODE
 %%Q-ALL-BUT-POINTER
...
;;;   and truly worthless symbols its too late to flush from global now
 ...
 *APPLYHOOK*					;common
 *ARRAY
 *BREAK-ON-WARNINGS*				;common
 *CATCH
 *DEBUG-IO*					;common
 *DEFAULT-PATHNAME-DEFAULTS*			;common -- incompatible
 *ERROR-OUTPUT*					;common
 *EVALHOOK*					;common
 *EXPR
 *FEATURES*					;common
 ...
 *LEXPR-ARGLIST*
 *LOAD-VERBOSE*					;common
 *MACROEXPAND-HOOK*				;common
 *MODULES*					;common
 *NOPOINT
 *PACKAGE*					;common
 *PLUS *DIF *TIMES *QUO				;These for Maclisp compatibility. Ack.
 *PRINT-ARRAY*					;common
 *PRINT-BASE*					;common
 *PRINT-CASE*					;common
 *PRINT-CIRCLE*					;common
 ...
 *RANDOM-STATE*					;common
 *READ-BASE*					;common
 *READ-DEFAULT-FLOAT-FORMAT*			;common
 *READ-SUPPRESS*				;common
 *READTABLE*					;common
; *RSET
 *STANDARD-INPUT*				;common
 *STANDARD-OUTPUT*				;common
 *TERMINAL-IO*					;common
 *THROW
 *TRACE-OUTPUT*					;common
 *UNWIND-STACK
...
;CEIL						;obsolete
 ...
 CLASS-METHOD-SYMBOL				;obsolete
 CLASS-SYMBOL					;obsolete
 CLASS-SYMBOLP					;obsolete
 CLEAR-INPUT					;common
 CLEAR-MAR
 CLEAR-OUTPUT					;common
 CLEAR-RESOURCE
...
;PUTF
 ...
 SUB-APROPOS
 SUB1
 SUBCLASS-OF-CLASS-SYMBOL-P			;obsolete
 SUBCLASS-OF-CLASSP				;obsolete
 SUBINSTANCE-OF-CLASS-SYMBOL-P			;obsolete
 SUBINSTANCE-OF-CLASSP				;obsolete
 SUBLIS						;common
 SUBRP
 SUBSEQ						;common
 SUBSET
