...
;;; Reason:
;;;  There is no reason for the TAR-FORMAT dummy host to have a Chaos address.
;;; Written 5-Apr-88 15:46:40 by pld at site Gigamos Cambridge
...
; From modified file DJ: L.TAPE; TAR-FORMAT.LISP#27 at 5-Apr-88 15:46:41
#10R TAPE#: 
  ...
  `(setq *dummy-unix-host*
	 (progn
	   (si:define-host *dummy-unix-host-name*
			   ...
			   :system-type :unix
			   :no-network nil)
	   (fs:get-pathname-host *dummy-unix-host-name*)))
  '(:now)
