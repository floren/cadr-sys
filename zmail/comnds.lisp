...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-SELF-DOCUMENT
  "ZWEI line self help" (NO-ZMAIL-BUFFER-OK)
  (LET ((*COMTAB* *ZMAIL-COMTAB*))
    (COM-SELF-DOCUMENT)))

(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-APROPOS
  "List commands whose names contain a given string." (NO-ZMAIL-BUFFER-OK)
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-DOCUMENTATION "Minimal self help"
				(NO-ZMAIL-BUFFER-OK)
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-EXTENDED-COMMAND "Get at any top-level command"
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-DOWN-TO-NEXT
  "Move to next message, including deleted messages." (NUMERIC-ARG-OK)
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-UP-TO-PREVIOUS
  "Move to previous message, including deleted messages." (NUMERIC-ARG-OK)
...
With numeric arg, undelete message with specified number." (NUMERIC-ARG-OK)
  (IF *NUMERIC-ARG-P*
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-NOT-MODIFIED
  "Mark this buffer as not needing saving" (NO-MSG-OK)
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-EXPUNGE "Expunge the current buffer." (NO-MSG-OK)
...
(DEFUN FOREGROUND-BACKGROUND-FINISH (ZMAIL-BUFFER &OPTIONAL (ABORT-P T) STATUS)
  ...
  (LOCK-ZMAIL-BUFFER (ZMAIL-BUFFER)
	...
	(SETF (CAR *ZMAIL-BACKGROUND-REQUEST-CELL*)
		...
		(DEL-IF #'(LAMBDA (X)
			    (AND (MEMQ (CAR X) '(ZMAIL-BACKGROUND-SAVE-FILE
						 ZMAIL-BACKGROUND-LOAD-FILE))
...
(DEFUN ZMAIL-BUFFER-SAVE-SETUP (ZMAIL-BUFFER)
  (SETF (ZMAIL-DISK-BUFFER-STREAM ZMAIL-BUFFER)
	(OPEN (BUFFER-PATHNAME ZMAIL-BUFFER) :DIRECTION :OUTPUT :IF-EXISTS :SUPERSEDE))
...
(DEFINE-COMMAND-WHO-LINE-DOCUMENTATION-UPDATER COM-ZMAIL-MOVE (STRING &OPTIONAL RECURSIVE)
  (OR RECURSIVE
      (UPDATE-COMMAND-WHO-LINE-DOCUMENTATION 'GET-DEFAULTED-MOVE-ZMAIL-BUFFER NIL T))
...
(DEFUN GET-ZMAIL-BUFFER-ALISTS (&OPTIONAL OTHERS-TOO &AUX MFL TMFL MFL-PATHNAMES)
  ...
  (SETQ MFL-PATHNAMES (MAPCAR #'BUFFER-PATHNAME *ZMAIL-BUFFER-LIST*))
  (IF (FIND-IF #'STRINGP *OTHER-MAIL-FILE-NAMES*)
      (SETQ *OTHER-MAIL-FILE-NAMES* (MAPCAR #'PARSE-NAMESTRING *OTHER-MAIL-FILE-NAMES*)))
  (AND OTHERS-TOO
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-RENAME-BUFFER "Change the name of this buffer."
				(NO-MSG-OK)
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-REFRESH "Complete redisplay" (NO-ZMAIL-BUFFER-OK)
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-START-OF-MSG "Scroll back to start of message"
				(NO-ZMAIL-BUFFER-OK)
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-END-OF-MSG "Scroll to end of message"
				(NO-ZMAIL-BUFFER-OK)
  (MOVE-BP (WINDOW-POINT *WINDOW*)
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-SCROLL-SUMMARY-WINDOW "Scroll the summary window"
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-JUMP "Move to a specific message" (NUMERIC-ARG-OK)
  (IF *NUMERIC-ARG-P*
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-BREAK "Break loop" (NO-ZMAIL-BUFFER-OK)
  (LET ((*INSIDE-BREAK* T))
    (BREAK "ZMail"))
...
Right gives menu of operations." (NO-MSG-OK NUMERIC-ARG-OK)
  (COND ((EQ *ZMAIL-COMMAND-BUTTON* :RIGHT)
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-DELETE-ALL "Delete these messages." ()
  (SEND *SUMMARY-WINDOW* :NEED-FULL-REDISPLAY)
  (DOMSGS (MSG *ZMAIL-BUFFER*)
    (OR (MSG-GET MSG 'DELETED)
	(MSG-PUT MSG T 'DELETED)))
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-UNDELETE-ALL "Undelete all these messages." ()
  (SEND *SUMMARY-WINDOW* :NEED-FULL-REDISPLAY)
  (DOMSGS (MSG *ZMAIL-BUFFER*)
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-TYPE-ALL "Type out all these messages." ()
  (USING-OVERLYING-WINDOW
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-FIND-STRING
  "Move to next message containing specified string" (NUMERIC-ARG-OK)
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-FORWARD-ALL "Forward all these messages to someone."
				()
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-REPLY-ALL "Reply to all these messages at once." ()
  (LET (*DRAFT-MSG* *DRAFT-TEXT-INTERVAL* *DRAFT-HEADER-INTERVAL*)
...
(DEFUN READ-DIGEST-DESCRIPTION (F &AUX MAKE-DS-ARGS (EOF '(())))
  (WITH-OPEN-FILE (S F :DIRECTION :INPUT)
    ...
    (DO ((KEY (CLI:READ S NIL EOF) (CLI:READ S NIL EOF))
	 VAL)
	((EQ KEY EOF))
  ...
  (LET* ((DS (APPLY #'MAKE-DIGEST-STATUS MAKE-DS-ARGS)))
    ...
    (UNLESS (DS-MODERATOR-ADDRESS DS)
      (SETF (DS-MODERATOR-ADDRESS DS)
	    (OR (DS-REPLY-TO DS)
		(PARSE-ADDRESSES (FORMAT NIL "~A@~A" USER-ID FS:USER-LOGIN-MACHINE)))))
    DS))
...
(DEFUN MAKE-DIGEST-DRAFT-MSG (DS MSGS
  ...
  (WITH-OPEN-STREAM (S (INTERVAL-STREAM TEXT-INTERVAL NIL NIL NIL T))
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-VIEW-FILE "View a specified file."
				(NO-ZMAIL-BUFFER-OK)
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-LIST-BUFFERS "List the buffers in ZMAIL."
				(NO-ZMAIL-BUFFER-OK)
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-ENABLE-BACKGROUND-PROCESS-WHEN-DEEXPOSED
  "Allow the background process to run when deexposed" (NO-ZMAIL-BUFFER-OK NUMERIC-ARG-OK)
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-DELETE-DUPLICATE-MSGS
  ...
  (LET ((HASH-TABLE (MAKE-HASH-TABLE :SIZE (TRUNCATE (* (ZMAIL-BUFFER-NMSGS *ZMAIL-BUFFER*)
							5)
						     4)
				     :TEST #'EQUAL))
	(NDELETED 0)
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-ZMAIL-WHOIS "Print whois information on a user"
				(NO-ZMAIL-BUFFER-OK)
...
(DEFINE-ZMAIL-TOP-LEVEL-COMMAND COM-SELECT-ARBITRARY-FORMAT-MAIL-FILE
  "Read in a file and a specified format" (NO-ZMAIL-BUFFER-OK)
  (SET-ZMAIL-USER)
