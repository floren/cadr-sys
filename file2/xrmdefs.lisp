...
; #!<string-containing-hostname><string-for-host>
;as in #!"LFS""FOO\BAR#69"

;If READ-PATHNAME-HOST is non-NIL, it overrides the hostname which
;follows the #!.  The remote end uses this to stick the remote hostname
;in place of the local hostname from the server, which is what appears in the #!.
...
;This variable, if not NIL, says which host name to output in a #!,
...
;Certain frequently transmitted symbols are encoded as #?number.
...
(SET-SYNTAX-#-MACRO-CHAR #/! 'READ-PATHNAME FILE-READTABLE)

(SET-SYNTAX-#-MACRO-CHAR #/? 'READ-STANDARD-SYMBOL FILE-READTABLE)
